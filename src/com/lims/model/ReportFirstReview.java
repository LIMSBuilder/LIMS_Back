 ...
 */
public class ReportFirstReview extends Model<ReportFirstReview> {
    public static  ReportFirstReview reportFirstReview=new ReportFirstReview();
    ...
    public Map Json(){
        ...
        temp.put("condition7",this.get("condition7"));
